      ...
      <div className="w-full flex flex-wrap mt-10 gap-10 md:gap-20 justify-between">
        ...
        <div className="flex flex-col flex-[1_1_150px] space-y-2">
          ...
          <nav className="flex flex-col gap-1 text-lg text-gray-500">
            ...
            <Link to="/" className="hover:text-purple-600 transition-colors">Services</Link>
            <Link to="/" className="hover:text-purple-600 transition-colors">Categories</Link>
            <Link to="/" className="hover:text-purple-600 transition-colors">Products</Link>
            <Link to="/" className="hover:text-purple-600 transition-colors">FAQ</Link>
          </nav>
        </div>
